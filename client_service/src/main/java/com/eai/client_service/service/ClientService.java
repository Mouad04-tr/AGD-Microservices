...
import com.eai.openfeignservice.user.*;
...
public class ClientService {
    ...
    public List<ClientsForSatisfaction> getClientsForSatisf() {
        List<ClientsForSatisfaction> clients = new ArrayList<>();
        List<Client> clientList = clientRepository.findAll();
        for (Client client : clientList) {
            if (client.getClientStatus() == ClientStatus.CLIENT_BANQUE_AGENCE) {
                ClientsForSatisfaction clientsForSatisfaction = ClientsForSatisfaction.builder()
                        .id(client.getId())
                        .email(client.getEmail())
                        .nom(client.getNom())
                        .prenom(client.getPrenom())
                        .build();
                clients.add(clientsForSatisfaction);
            }
        }
        return clients;
    }
